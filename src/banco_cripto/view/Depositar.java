...
public class Depositar extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            double valorDepositado = Double.parseDouble(valorTexto);

            // Verifica se o valor é positivo
            if (valorDepositado > 0) {
                // Atualiza o saldo da carteira com o valor depositado
                investidorLogado.getCarteira().depositar(valorDepositado);

                // Exibe a confirmação e o novo saldo
                JOptionPane.showMessageDialog(this, String.format("Depósito de R$ %.2f realizado com sucesso!", valorDepositado));

            } else {
                // Caso o valor seja negativo ou zero
                JOptionPane.showMessageDialog(this, "O valor a ser depositado deve ser positivo.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
